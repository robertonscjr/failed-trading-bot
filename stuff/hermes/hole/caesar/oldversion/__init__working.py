...
#               print "Exception in core: %s : %s" % (e, self._time())
		...
		good_volume = (volume_do_dia > 20.0)
...
#                   print "(%s) - Update minimum: %s" % (pair, self._time())
                ...
                open_candle = first_candle['open']
                close_candle = first_candle['close']
                close_larger_than_open = close_candle > open_candle

                can_enter_strategy = (have_hole and have_cases_enough \
#                                    and (last >= self.minimum[pair] * 1.015)
                                     and close_larger_than_open and good_volume)
